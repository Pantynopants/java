...
//		}
		...
		Socket newCommandSocket = null;
		try {
			newCommandSocket = new Socket(HOST,newport);
			//System.out.println(newCommandSocket.getLocalPort());
			//System.out.println(newCommandSocket.getPort());
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
